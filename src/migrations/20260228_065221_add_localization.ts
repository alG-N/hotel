...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  INSERT INTO "pages_hero_links_locales" ("link_label", "_locale", "_parent_id") SELECT "link_label", 'vi', "id" FROM "pages_hero_links" WHERE "link_label" IS NOT NULL;
  INSERT INTO "pages_blocks_cta_links_locales" ("link_label", "_locale", "_parent_id") SELECT "link_label", 'vi', "id" FROM "pages_blocks_cta_links" WHERE "link_label" IS NOT NULL;
  INSERT INTO "pages_blocks_cta_locales" ("rich_text", "_locale", "_parent_id") SELECT "rich_text", 'vi', "id" FROM "pages_blocks_cta" WHERE "rich_text" IS NOT NULL;
  INSERT INTO "pages_blocks_content_columns_locales" ("rich_text", "link_label", "_locale", "_parent_id") SELECT "rich_text", "link_label", 'vi', "id" FROM "pages_blocks_content_columns" WHERE "rich_text" IS NOT NULL OR "link_label" IS NOT NULL;
  INSERT INTO "pages_blocks_archive_locales" ("intro_content", "_locale", "_parent_id") SELECT "intro_content", 'vi', "id" FROM "pages_blocks_archive" WHERE "intro_content" IS NOT NULL;
  INSERT INTO "pages_blocks_form_block_locales" ("intro_content", "_locale", "_parent_id") SELECT "intro_content", 'vi', "id" FROM "pages_blocks_form_block" WHERE "intro_content" IS NOT NULL;
  INSERT INTO "pages_blocks_hero_locales" ("subtitle", "name", "tagline", "cta_text", "_locale", "_parent_id") SELECT "subtitle", "name", "tagline", "cta_text", 'vi', "id" FROM "pages_blocks_hero" WHERE "subtitle" IS NOT NULL OR "name" IS NOT NULL OR "tagline" IS NOT NULL OR "cta_text" IS NOT NULL;
  INSERT INTO "pages_blocks_description_locales" ("title", "left_text", "cta_text", "right_text", "_locale", "_parent_id") SELECT "title", "left_text", "cta_text", "right_text", 'vi', "id" FROM "pages_blocks_description" WHERE "title" IS NOT NULL OR "left_text" IS NOT NULL OR "cta_text" IS NOT NULL OR "right_text" IS NOT NULL;
  INSERT INTO "pages_blocks_rooms_grid_custom_categories_locales" ("name", "_locale", "_parent_id") SELECT "name", 'vi', "id" FROM "pages_blocks_rooms_grid_custom_categories" WHERE "name" IS NOT NULL;
  INSERT INTO "pages_blocks_rooms_grid_rooms_amenities_locales" ("text", "_locale", "_parent_id") SELECT "text", 'vi', "id" FROM "pages_blocks_rooms_grid_rooms_amenities" WHERE "text" IS NOT NULL;
  INSERT INTO "pages_blocks_rooms_grid_rooms_locales" ("name", "subtitle", "_locale", "_parent_id") SELECT "name", "subtitle", 'vi', "id" FROM "pages_blocks_rooms_grid_rooms" WHERE "name" IS NOT NULL OR "subtitle" IS NOT NULL;
  INSERT INTO "pages_blocks_accommodations_type2_rooms_features_locales" ("text", "_locale", "_parent_id") SELECT "text", 'vi', "id" FROM "pages_blocks_accommodations_type2_rooms_features" WHERE "text" IS NOT NULL;
  INSERT INTO "pages_blocks_accommodations_type2_rooms_locales" ("name", "description", "button_text", "_locale", "_parent_id") SELECT "name", "description", "button_text", 'vi', "id" FROM "pages_blocks_accommodations_type2_rooms" WHERE "name" IS NOT NULL OR "description" IS NOT NULL OR "button_text" IS NOT NULL;
  INSERT INTO "pages_blocks_accommodations_type2_locales" ("title", "cta_text", "_locale", "_parent_id") SELECT "title", "cta_text", 'vi', "id" FROM "pages_blocks_accommodations_type2" WHERE "title" IS NOT NULL OR "cta_text" IS NOT NULL;
  INSERT INTO "pages_blocks_food_drink_cuisine_options_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "pages_blocks_food_drink_cuisine_options" WHERE "label" IS NOT NULL;
  INSERT INTO "pages_blocks_food_drink_occasion_options_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "pages_blocks_food_drink_occasion_options" WHERE "label" IS NOT NULL;
  INSERT INTO "pages_blocks_food_drink_food_type_options_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "pages_blocks_food_drink_food_type_options" WHERE "label" IS NOT NULL;
  INSERT INTO "pages_blocks_food_drink_side_items_locales" ("title", "description", "_locale", "_parent_id") SELECT "title", "description", 'vi', "id" FROM "pages_blocks_food_drink_side_items" WHERE "title" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "pages_blocks_food_drink_locales" ("title", "featured_title", "featured_description", "_locale", "_parent_id") SELECT "title", "featured_title", "featured_description", 'vi', "id" FROM "pages_blocks_food_drink" WHERE "title" IS NOT NULL OR "featured_title" IS NOT NULL OR "featured_description" IS NOT NULL;
  INSERT INTO "pages_blocks_offers_features_locales" ("feature", "_locale", "_parent_id") SELECT "feature", 'vi', "id" FROM "pages_blocks_offers_features" WHERE "feature" IS NOT NULL;
  INSERT INTO "pages_blocks_offers_locales" ("title", "description", "price_highlight", "features_title", "cta_text", "_locale", "_parent_id") SELECT "title", "description", "price_highlight", "features_title", "cta_text", 'vi', "id" FROM "pages_blocks_offers" WHERE "title" IS NOT NULL OR "description" IS NOT NULL OR "price_highlight" IS NOT NULL OR "features_title" IS NOT NULL OR "cta_text" IS NOT NULL;
  INSERT INTO "pages_blocks_gallery_locales" ("see_all_text", "_locale", "_parent_id") SELECT "see_all_text", 'vi', "id" FROM "pages_blocks_gallery" WHERE "see_all_text" IS NOT NULL;
  INSERT INTO "pages_blocks_photo_gallery_locales" ("title", "load_more_text", "_locale", "_parent_id") SELECT "title", "load_more_text", 'vi', "id" FROM "pages_blocks_photo_gallery" WHERE "title" IS NOT NULL OR "load_more_text" IS NOT NULL;
  INSERT INTO "pages_blocks_location_parking_items_locales" ("text", "_locale", "_parent_id") SELECT "text", 'vi', "id" FROM "pages_blocks_location_parking_items" WHERE "text" IS NOT NULL;
  INSERT INTO "pages_blocks_location_getting_there_items_locales" ("title", "content", "_locale", "_parent_id") SELECT "title", "content", 'vi', "id" FROM "pages_blocks_location_getting_there_items" WHERE "title" IS NOT NULL OR "content" IS NOT NULL;
  INSERT INTO "pages_blocks_location_locales" ("section_title", "address1_label", "address1", "address2_label", "address2", "location_label", "full_address", "reservation_label", "hotline_label", "email_label", "parking_label", "getting_there_title", "cta_text", "_locale", "_parent_id") SELECT "section_title", "address1_label", "address1", "address2_label", "address2", "location_label", "full_address", "reservation_label", "hotline_label", "email_label", "parking_label", "getting_there_title", "cta_text", 'vi', "id" FROM "pages_blocks_location" WHERE "section_title" IS NOT NULL OR "address1_label" IS NOT NULL OR "address1" IS NOT NULL OR "address2_label" IS NOT NULL OR "address2" IS NOT NULL OR "location_label" IS NOT NULL OR "full_address" IS NOT NULL OR "reservation_label" IS NOT NULL OR "hotline_label" IS NOT NULL OR "email_label" IS NOT NULL OR "parking_label" IS NOT NULL OR "getting_there_title" IS NOT NULL OR "cta_text" IS NOT NULL;
  INSERT INTO "pages_blocks_our_services_services_locales" ("service_name", "service_description", "_locale", "_parent_id") SELECT "service_name", "service_description", 'vi', "id" FROM "pages_blocks_our_services_services" WHERE "service_name" IS NOT NULL OR "service_description" IS NOT NULL;
  INSERT INTO "pages_blocks_our_services_locales" ("section_title", "section_description", "_locale", "_parent_id") SELECT "section_title", "section_description", 'vi', "id" FROM "pages_blocks_our_services" WHERE "section_title" IS NOT NULL OR "section_description" IS NOT NULL;
  INSERT INTO "pages_blocks_content_image_highlight_section_items_locales" ("text", "_locale", "_parent_id") SELECT "text", 'vi', "id" FROM "pages_blocks_content_image_highlight_section_items" WHERE "text" IS NOT NULL;
  INSERT INTO "pages_blocks_content_image_locales" ("title", "description", "highlight_section_title", "cta_text", "_locale", "_parent_id") SELECT "title", "description", "highlight_section_title", "cta_text", 'vi', "id" FROM "pages_blocks_content_image" WHERE "title" IS NOT NULL OR "description" IS NOT NULL OR "highlight_section_title" IS NOT NULL OR "cta_text" IS NOT NULL;
  INSERT INTO "pages_blocks_the_space_stats_locales" ("value", "description", "_locale", "_parent_id") SELECT "value", "description", 'vi', "id" FROM "pages_blocks_the_space_stats" WHERE "value" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "pages_blocks_the_space_locales" ("section_title", "section_description", "_locale", "_parent_id") SELECT "section_title", "section_description", 'vi', "id" FROM "pages_blocks_the_space" WHERE "section_title" IS NOT NULL OR "section_description" IS NOT NULL;
  INSERT INTO "pages_blocks_special_offers_offers_locales" ("title", "description", "cta_text", "_locale", "_parent_id") SELECT "title", "description", "cta_text", 'vi', "id" FROM "pages_blocks_special_offers_offers" WHERE "title" IS NOT NULL OR "description" IS NOT NULL OR "cta_text" IS NOT NULL;
  INSERT INTO "pages_blocks_special_offers_locales" ("section_title", "_locale", "_parent_id") SELECT "section_title", 'vi', "id" FROM "pages_blocks_special_offers" WHERE "section_title" IS NOT NULL;
  INSERT INTO "pages_blocks_vision_cards_locales" ("title", "description", "_locale", "_parent_id") SELECT "title", "description", 'vi', "id" FROM "pages_blocks_vision_cards" WHERE "title" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "pages_blocks_vision_locales" ("main_title", "main_description", "_locale", "_parent_id") SELECT "main_title", "main_description", 'vi', "id" FROM "pages_blocks_vision" WHERE "main_title" IS NOT NULL OR "main_description" IS NOT NULL;
  INSERT INTO "pages_blocks_designed_features_locales" ("title", "description", "_locale", "_parent_id") SELECT "title", "description", 'vi', "id" FROM "pages_blocks_designed_features" WHERE "title" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "pages_blocks_designed_locales" ("title", "description", "_locale", "_parent_id") SELECT "title", "description", 'vi', "id" FROM "pages_blocks_designed" WHERE "title" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "pages_blocks_collaboration_partners_locales" ("name", "_locale", "_parent_id") SELECT "name", 'vi', "id" FROM "pages_blocks_collaboration_partners" WHERE "name" IS NOT NULL;
  INSERT INTO "pages_blocks_collaboration_locales" ("title", "description", "_locale", "_parent_id") SELECT "title", "description", 'vi', "id" FROM "pages_blocks_collaboration" WHERE "title" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "pages_blocks_description_type2_locales" ("title", "paragraph1", "paragraph2", "_locale", "_parent_id") SELECT "title", "paragraph1", "paragraph2", 'vi', "id" FROM "pages_blocks_description_type2" WHERE "title" IS NOT NULL OR "paragraph1" IS NOT NULL OR "paragraph2" IS NOT NULL;
  INSERT INTO "pages_blocks_booking_form_room_types_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "pages_blocks_booking_form_room_types" WHERE "label" IS NOT NULL;
  INSERT INTO "pages_blocks_booking_form_info_cards_locales" ("title", "description", "_locale", "_parent_id") SELECT "title", "description", 'vi', "id" FROM "pages_blocks_booking_form_info_cards" WHERE "title" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "pages_blocks_booking_form_locales" ("title", "subtitle", "button_text", "_locale", "_parent_id") SELECT "title", "subtitle", "button_text", 'vi', "id" FROM "pages_blocks_booking_form" WHERE "title" IS NOT NULL OR "subtitle" IS NOT NULL OR "button_text" IS NOT NULL;
  INSERT INTO "pages_blocks_subscribe_benefits_locales" ("text", "_locale", "_parent_id") SELECT "text", 'vi', "id" FROM "pages_blocks_subscribe_benefits" WHERE "text" IS NOT NULL;
  INSERT INTO "pages_blocks_subscribe_locales" ("title", "subtitle", "placeholder_text", "button_text", "success_message", "privacy_text", "_locale", "_parent_id") SELECT "title", "subtitle", "placeholder_text", "button_text", "success_message", "privacy_text", 'vi', "id" FROM "pages_blocks_subscribe" WHERE "title" IS NOT NULL OR "subtitle" IS NOT NULL OR "placeholder_text" IS NOT NULL OR "button_text" IS NOT NULL OR "success_message" IS NOT NULL OR "privacy_text" IS NOT NULL;
  INSERT INTO "pages_locales" ("title", "hero_rich_text", "meta_title", "meta_image_id", "meta_description", "_locale", "_parent_id") SELECT "title", "hero_rich_text", "meta_title", "meta_image_id", "meta_description", 'vi', "id" FROM "pages" WHERE "title" IS NOT NULL OR "hero_rich_text" IS NOT NULL OR "meta_title" IS NOT NULL OR "meta_image_id" IS NOT NULL OR "meta_description" IS NOT NULL;
  INSERT INTO "_pages_v_version_hero_links_locales" ("link_label", "_locale", "_parent_id") SELECT "link_label", 'vi', "id" FROM "_pages_v_version_hero_links" WHERE "link_label" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_cta_links_locales" ("link_label", "_locale", "_parent_id") SELECT "link_label", 'vi', "id" FROM "_pages_v_blocks_cta_links" WHERE "link_label" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_cta_locales" ("rich_text", "_locale", "_parent_id") SELECT "rich_text", 'vi', "id" FROM "_pages_v_blocks_cta" WHERE "rich_text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_content_columns_locales" ("rich_text", "link_label", "_locale", "_parent_id") SELECT "rich_text", "link_label", 'vi', "id" FROM "_pages_v_blocks_content_columns" WHERE "rich_text" IS NOT NULL OR "link_label" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_archive_locales" ("intro_content", "_locale", "_parent_id") SELECT "intro_content", 'vi', "id" FROM "_pages_v_blocks_archive" WHERE "intro_content" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_form_block_locales" ("intro_content", "_locale", "_parent_id") SELECT "intro_content", 'vi', "id" FROM "_pages_v_blocks_form_block" WHERE "intro_content" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_hero_locales" ("subtitle", "name", "tagline", "cta_text", "_locale", "_parent_id") SELECT "subtitle", "name", "tagline", "cta_text", 'vi', "id" FROM "_pages_v_blocks_hero" WHERE "subtitle" IS NOT NULL OR "name" IS NOT NULL OR "tagline" IS NOT NULL OR "cta_text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_description_locales" ("title", "left_text", "cta_text", "right_text", "_locale", "_parent_id") SELECT "title", "left_text", "cta_text", "right_text", 'vi', "id" FROM "_pages_v_blocks_description" WHERE "title" IS NOT NULL OR "left_text" IS NOT NULL OR "cta_text" IS NOT NULL OR "right_text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_rooms_grid_custom_categories_locales" ("name", "_locale", "_parent_id") SELECT "name", 'vi', "id" FROM "_pages_v_blocks_rooms_grid_custom_categories" WHERE "name" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_rooms_grid_rooms_amenities_locales" ("text", "_locale", "_parent_id") SELECT "text", 'vi', "id" FROM "_pages_v_blocks_rooms_grid_rooms_amenities" WHERE "text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_rooms_grid_rooms_locales" ("name", "subtitle", "_locale", "_parent_id") SELECT "name", "subtitle", 'vi', "id" FROM "_pages_v_blocks_rooms_grid_rooms" WHERE "name" IS NOT NULL OR "subtitle" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_accommodations_type2_rooms_features_locales" ("text", "_locale", "_parent_id") SELECT "text", 'vi', "id" FROM "_pages_v_blocks_accommodations_type2_rooms_features" WHERE "text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_accommodations_type2_rooms_locales" ("name", "description", "button_text", "_locale", "_parent_id") SELECT "name", "description", "button_text", 'vi', "id" FROM "_pages_v_blocks_accommodations_type2_rooms" WHERE "name" IS NOT NULL OR "description" IS NOT NULL OR "button_text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_accommodations_type2_locales" ("title", "cta_text", "_locale", "_parent_id") SELECT "title", "cta_text", 'vi', "id" FROM "_pages_v_blocks_accommodations_type2" WHERE "title" IS NOT NULL OR "cta_text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_food_drink_cuisine_options_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "_pages_v_blocks_food_drink_cuisine_options" WHERE "label" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_food_drink_occasion_options_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "_pages_v_blocks_food_drink_occasion_options" WHERE "label" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_food_drink_food_type_options_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "_pages_v_blocks_food_drink_food_type_options" WHERE "label" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_food_drink_side_items_locales" ("title", "description", "_locale", "_parent_id") SELECT "title", "description", 'vi', "id" FROM "_pages_v_blocks_food_drink_side_items" WHERE "title" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_food_drink_locales" ("title", "featured_title", "featured_description", "_locale", "_parent_id") SELECT "title", "featured_title", "featured_description", 'vi', "id" FROM "_pages_v_blocks_food_drink" WHERE "title" IS NOT NULL OR "featured_title" IS NOT NULL OR "featured_description" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_offers_features_locales" ("feature", "_locale", "_parent_id") SELECT "feature", 'vi', "id" FROM "_pages_v_blocks_offers_features" WHERE "feature" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_offers_locales" ("title", "description", "price_highlight", "features_title", "cta_text", "_locale", "_parent_id") SELECT "title", "description", "price_highlight", "features_title", "cta_text", 'vi', "id" FROM "_pages_v_blocks_offers" WHERE "title" IS NOT NULL OR "description" IS NOT NULL OR "price_highlight" IS NOT NULL OR "features_title" IS NOT NULL OR "cta_text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_gallery_locales" ("see_all_text", "_locale", "_parent_id") SELECT "see_all_text", 'vi', "id" FROM "_pages_v_blocks_gallery" WHERE "see_all_text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_photo_gallery_locales" ("title", "load_more_text", "_locale", "_parent_id") SELECT "title", "load_more_text", 'vi', "id" FROM "_pages_v_blocks_photo_gallery" WHERE "title" IS NOT NULL OR "load_more_text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_location_parking_items_locales" ("text", "_locale", "_parent_id") SELECT "text", 'vi', "id" FROM "_pages_v_blocks_location_parking_items" WHERE "text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_location_getting_there_items_locales" ("title", "content", "_locale", "_parent_id") SELECT "title", "content", 'vi', "id" FROM "_pages_v_blocks_location_getting_there_items" WHERE "title" IS NOT NULL OR "content" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_location_locales" ("section_title", "address1_label", "address1", "address2_label", "address2", "location_label", "full_address", "reservation_label", "hotline_label", "email_label", "parking_label", "getting_there_title", "cta_text", "_locale", "_parent_id") SELECT "section_title", "address1_label", "address1", "address2_label", "address2", "location_label", "full_address", "reservation_label", "hotline_label", "email_label", "parking_label", "getting_there_title", "cta_text", 'vi', "id" FROM "_pages_v_blocks_location" WHERE "section_title" IS NOT NULL OR "address1_label" IS NOT NULL OR "address1" IS NOT NULL OR "address2_label" IS NOT NULL OR "address2" IS NOT NULL OR "location_label" IS NOT NULL OR "full_address" IS NOT NULL OR "reservation_label" IS NOT NULL OR "hotline_label" IS NOT NULL OR "email_label" IS NOT NULL OR "parking_label" IS NOT NULL OR "getting_there_title" IS NOT NULL OR "cta_text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_our_services_services_locales" ("service_name", "service_description", "_locale", "_parent_id") SELECT "service_name", "service_description", 'vi', "id" FROM "_pages_v_blocks_our_services_services" WHERE "service_name" IS NOT NULL OR "service_description" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_our_services_locales" ("section_title", "section_description", "_locale", "_parent_id") SELECT "section_title", "section_description", 'vi', "id" FROM "_pages_v_blocks_our_services" WHERE "section_title" IS NOT NULL OR "section_description" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_content_image_highlight_section_items_locales" ("text", "_locale", "_parent_id") SELECT "text", 'vi', "id" FROM "_pages_v_blocks_content_image_highlight_section_items" WHERE "text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_content_image_locales" ("title", "description", "highlight_section_title", "cta_text", "_locale", "_parent_id") SELECT "title", "description", "highlight_section_title", "cta_text", 'vi', "id" FROM "_pages_v_blocks_content_image" WHERE "title" IS NOT NULL OR "description" IS NOT NULL OR "highlight_section_title" IS NOT NULL OR "cta_text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_the_space_stats_locales" ("value", "description", "_locale", "_parent_id") SELECT "value", "description", 'vi', "id" FROM "_pages_v_blocks_the_space_stats" WHERE "value" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_the_space_locales" ("section_title", "section_description", "_locale", "_parent_id") SELECT "section_title", "section_description", 'vi', "id" FROM "_pages_v_blocks_the_space" WHERE "section_title" IS NOT NULL OR "section_description" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_special_offers_offers_locales" ("title", "description", "cta_text", "_locale", "_parent_id") SELECT "title", "description", "cta_text", 'vi', "id" FROM "_pages_v_blocks_special_offers_offers" WHERE "title" IS NOT NULL OR "description" IS NOT NULL OR "cta_text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_special_offers_locales" ("section_title", "_locale", "_parent_id") SELECT "section_title", 'vi', "id" FROM "_pages_v_blocks_special_offers" WHERE "section_title" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_vision_cards_locales" ("title", "description", "_locale", "_parent_id") SELECT "title", "description", 'vi', "id" FROM "_pages_v_blocks_vision_cards" WHERE "title" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_vision_locales" ("main_title", "main_description", "_locale", "_parent_id") SELECT "main_title", "main_description", 'vi', "id" FROM "_pages_v_blocks_vision" WHERE "main_title" IS NOT NULL OR "main_description" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_designed_features_locales" ("title", "description", "_locale", "_parent_id") SELECT "title", "description", 'vi', "id" FROM "_pages_v_blocks_designed_features" WHERE "title" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_designed_locales" ("title", "description", "_locale", "_parent_id") SELECT "title", "description", 'vi', "id" FROM "_pages_v_blocks_designed" WHERE "title" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_collaboration_partners_locales" ("name", "_locale", "_parent_id") SELECT "name", 'vi', "id" FROM "_pages_v_blocks_collaboration_partners" WHERE "name" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_collaboration_locales" ("title", "description", "_locale", "_parent_id") SELECT "title", "description", 'vi', "id" FROM "_pages_v_blocks_collaboration" WHERE "title" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_description_type2_locales" ("title", "paragraph1", "paragraph2", "_locale", "_parent_id") SELECT "title", "paragraph1", "paragraph2", 'vi', "id" FROM "_pages_v_blocks_description_type2" WHERE "title" IS NOT NULL OR "paragraph1" IS NOT NULL OR "paragraph2" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_booking_form_room_types_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "_pages_v_blocks_booking_form_room_types" WHERE "label" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_booking_form_info_cards_locales" ("title", "description", "_locale", "_parent_id") SELECT "title", "description", 'vi', "id" FROM "_pages_v_blocks_booking_form_info_cards" WHERE "title" IS NOT NULL OR "description" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_booking_form_locales" ("title", "subtitle", "button_text", "_locale", "_parent_id") SELECT "title", "subtitle", "button_text", 'vi', "id" FROM "_pages_v_blocks_booking_form" WHERE "title" IS NOT NULL OR "subtitle" IS NOT NULL OR "button_text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_subscribe_benefits_locales" ("text", "_locale", "_parent_id") SELECT "text", 'vi', "id" FROM "_pages_v_blocks_subscribe_benefits" WHERE "text" IS NOT NULL;
  INSERT INTO "_pages_v_blocks_subscribe_locales" ("title", "subtitle", "placeholder_text", "button_text", "success_message", "privacy_text", "_locale", "_parent_id") SELECT "title", "subtitle", "placeholder_text", "button_text", "success_message", "privacy_text", 'vi', "id" FROM "_pages_v_blocks_subscribe" WHERE "title" IS NOT NULL OR "subtitle" IS NOT NULL OR "placeholder_text" IS NOT NULL OR "button_text" IS NOT NULL OR "success_message" IS NOT NULL OR "privacy_text" IS NOT NULL;
  INSERT INTO "_pages_v_locales" ("version_title", "version_hero_rich_text", "version_meta_title", "version_meta_image_id", "version_meta_description", "_locale", "_parent_id") SELECT "version_title", "version_hero_rich_text", "version_meta_title", "version_meta_image_id", "version_meta_description", 'vi', "id" FROM "_pages_v" WHERE "version_title" IS NOT NULL OR "version_hero_rich_text" IS NOT NULL OR "version_meta_title" IS NOT NULL OR "version_meta_image_id" IS NOT NULL OR "version_meta_description" IS NOT NULL;
  INSERT INTO "posts_locales" ("title", "content", "meta_title", "meta_image_id", "meta_description", "_locale", "_parent_id") SELECT "title", "content", "meta_title", "meta_image_id", "meta_description", 'vi', "id" FROM "posts" WHERE "title" IS NOT NULL OR "content" IS NOT NULL OR "meta_title" IS NOT NULL OR "meta_image_id" IS NOT NULL OR "meta_description" IS NOT NULL;
  INSERT INTO "_posts_v_locales" ("version_title", "version_content", "version_meta_title", "version_meta_image_id", "version_meta_description", "_locale", "_parent_id") SELECT "version_title", "version_content", "version_meta_title", "version_meta_image_id", "version_meta_description", 'vi', "id" FROM "_posts_v" WHERE "version_title" IS NOT NULL OR "version_content" IS NOT NULL OR "version_meta_title" IS NOT NULL OR "version_meta_image_id" IS NOT NULL OR "version_meta_description" IS NOT NULL;
  INSERT INTO "media_locales" ("alt", "caption", "_locale", "_parent_id") SELECT "alt", "caption", 'vi', "id" FROM "media" WHERE "alt" IS NOT NULL OR "caption" IS NOT NULL;
  INSERT INTO "categories_locales" ("title", "_locale", "_parent_id") SELECT "title", 'vi', "id" FROM "categories" WHERE "title" IS NOT NULL;
  INSERT INTO "forms_blocks_checkbox_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "forms_blocks_checkbox" WHERE "label" IS NOT NULL;
  INSERT INTO "forms_blocks_country_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "forms_blocks_country" WHERE "label" IS NOT NULL;
  INSERT INTO "forms_blocks_email_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "forms_blocks_email" WHERE "label" IS NOT NULL;
  INSERT INTO "forms_blocks_message_locales" ("message", "_locale", "_parent_id") SELECT "message", 'vi', "id" FROM "forms_blocks_message" WHERE "message" IS NOT NULL;
  INSERT INTO "forms_blocks_number_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "forms_blocks_number" WHERE "label" IS NOT NULL;
  INSERT INTO "forms_blocks_select_options_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "forms_blocks_select_options" WHERE "label" IS NOT NULL;
  INSERT INTO "forms_blocks_select_locales" ("label", "default_value", "_locale", "_parent_id") SELECT "label", "default_value", 'vi', "id" FROM "forms_blocks_select" WHERE "label" IS NOT NULL OR "default_value" IS NOT NULL;
  INSERT INTO "forms_blocks_state_locales" ("label", "_locale", "_parent_id") SELECT "label", 'vi', "id" FROM "forms_blocks_state" WHERE "label" IS NOT NULL;
  INSERT INTO "forms_blocks_text_locales" ("label", "default_value", "_locale", "_parent_id") SELECT "label", "default_value", 'vi', "id" FROM "forms_blocks_text" WHERE "label" IS NOT NULL OR "default_value" IS NOT NULL;
  INSERT INTO "forms_blocks_textarea_locales" ("label", "default_value", "_locale", "_parent_id") SELECT "label", "default_value", 'vi', "id" FROM "forms_blocks_textarea" WHERE "label" IS NOT NULL OR "default_value" IS NOT NULL;
  INSERT INTO "forms_emails_locales" ("subject", "message", "_locale", "_parent_id") SELECT "subject", "message", 'vi', "id" FROM "forms_emails" WHERE "subject" IS NOT NULL OR "message" IS NOT NULL;
  INSERT INTO "forms_locales" ("submit_button_label", "confirmation_message", "_locale", "_parent_id") SELECT "submit_button_label", "confirmation_message", 'vi', "id" FROM "forms" WHERE "submit_button_label" IS NOT NULL OR "confirmation_message" IS NOT NULL;
  INSERT INTO "search_locales" ("title", "_locale", "_parent_id") SELECT "title", 'vi', "id" FROM "search" WHERE "title" IS NOT NULL;
  INSERT INTO "header_nav_items_left_locales" ("link_label", "_locale", "_parent_id") SELECT "link_label", 'vi', "id" FROM "header_nav_items_left" WHERE "link_label" IS NOT NULL;
  INSERT INTO "header_nav_items_right_locales" ("link_label", "_locale", "_parent_id") SELECT "link_label", 'vi', "id" FROM "header_nav_items_right" WHERE "link_label" IS NOT NULL;
  INSERT INTO "header_nav_items_locales" ("link_label", "_locale", "_parent_id") SELECT "link_label", 'vi', "id" FROM "header_nav_items" WHERE "link_label" IS NOT NULL;
  INSERT INTO "header_locales" ("cta_text", "_locale", "_parent_id") SELECT "cta_text", 'vi', "id" FROM "header" WHERE "cta_text" IS NOT NULL;
  INSERT INTO "footer_addresses_locales" ("address", "_locale", "_parent_id") SELECT "address", 'vi', "id" FROM "footer_addresses" WHERE "address" IS NOT NULL;
  INSERT INTO "footer_nav_links_locales" ("link_label", "_locale", "_parent_id") SELECT "link_label", 'vi', "id" FROM "footer_nav_links" WHERE "link_label" IS NOT NULL;
  INSERT INTO "footer_locales" ("subscribe_title", "subscribe_subtitle", "subscribe_button_text", "find_us_text", "copyright_text", "_locale", "_parent_id") SELECT "subscribe_title", "subscribe_subtitle", "subscribe_button_text", "find_us_text", "copyright_text", 'vi', "id" FROM "footer" WHERE "subscribe_title" IS NOT NULL OR "subscribe_subtitle" IS NOT NULL OR "subscribe_button_text" IS NOT NULL OR "find_us_text" IS NOT NULL OR "copyright_text" IS NOT NULL;
  INSERT INTO "advertisement_locales" ("top_banner_text", "top_banner_cta_text", "popup_title", "popup_description", "popup_cta_text", "floating_bar_text", "floating_bar_cta_text", "slide_in_title", "slide_in_description", "slide_in_cta_text", "_locale", "_parent_id") SELECT "top_banner_text", "top_banner_cta_text", "popup_title", "popup_description", "popup_cta_text", "floating_bar_text", "floating_bar_cta_text", "slide_in_title", "slide_in_description", "slide_in_cta_text", 'vi', "id" FROM "advertisement" WHERE "top_banner_text" IS NOT NULL OR "top_banner_cta_text" IS NOT NULL OR "popup_title" IS NOT NULL OR "popup_description" IS NOT NULL OR "popup_cta_text" IS NOT NULL OR "floating_bar_text" IS NOT NULL OR "floating_bar_cta_text" IS NOT NULL OR "slide_in_title" IS NOT NULL OR "slide_in_description" IS NOT NULL OR "slide_in_cta_text" IS NOT NULL;
