...
// A base64 encoded image to use as a placeholder while the image is loading (dark #1a1a1a)
const placeholderBlur =
  'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAIAAAD8GO2jAAAAJ0lEQVR4nO3NMQ0AAAwDoOqof6FVsWMJGCA9FoFAIBAIBAKBQPAlGPrtOBCzMe61AAAAAElFTkSuQmCC'
